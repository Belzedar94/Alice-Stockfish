...
class Worker {
   public:
    ...
    // Synchronous per-worker entry point linked only into the isolated Alice
    // data-generator target. The unconditional declaration keeps the Worker
    // class definition identical in every translation unit.
