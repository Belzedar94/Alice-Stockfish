...
// CapturePieceToHistory is addressed by a move's [board][piece][to][captured piece type]
using CapturePieceToHistory = Stats<i16, 10692, BOARD_NB, PIECE_NB, SQUARE_NB, PIECE_TYPE_NB>;
