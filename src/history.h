...
// It uses one table for each board and color, indexed by the move's from and to squares,
// see https://www.chessprogramming.org/Butterfly_Boards
using ButterflyHistory = Stats<i16, 7183, BOARD_NB, COLOR_NB, UINT_16_HISTORY_SIZE>;
